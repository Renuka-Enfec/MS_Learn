...
public class not_Word_check_TC {
       ...
       // List<WebElement> questions = driver.findElements(By.xpath("//div[@role='list']/div[@role='listitem']//div[@role='radiogroup']//p") );
        ...
        for (WebElement q : questions) {
            ...
            if (text.contains("not")) {
                System.out.println("Contains 'NOT' word");
            } else {
                System.out.println("'not' word not present in question");
            }
            System.out.println();
        }
        System.out.println("'not' word not present in questions, TC is passed");
